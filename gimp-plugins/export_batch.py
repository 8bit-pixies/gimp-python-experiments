...
template = {
    ...
    "xcf_to_jpg_showall": """gimp-console -idf --batch-interpreter python-fu-eval -b "import sys;sys.path.insert(0, '/home/chapman/Github/opensandwich/gimp-plugins'); import xcf_to_jpg_showall; xcf_to_jpg_showall.xcf_to_jpg_showall('{}',)" -b "pdb.gimp_quit(1)" """,
}
...
for f in glob.glob("../夏天只是一天/scans/ch16/*.xcf"):
    print(f)
    shcode = template["xcf_to_jpg_showall"].format(f)
    subprocess.call(shcode, shell=True)
